...
pub mod zthabitat {
    ...
    pub const GET_SPECIES_RATING: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const f32, i32) -> *const f32> = FunctionDef{address: 0x004d92db, function_type: PhantomData};
