...
pub mod bfaimgr {
    ...
    pub const SAVE: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u32) -> bool> = FunctionDef{address: 0x0047b081, function_type: PhantomData};
...
pub mod bfentity {
    ...
    pub const CHECK_AVOID_EDGES: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u32) -> bool> = FunctionDef{address: 0x004149e6, function_type: PhantomData};
    ...
    pub const GET_PLACEMENT_FOOTPRINT: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u32)> = FunctionDef{address: 0x004272d4, function_type: PhantomData};
...
pub mod bfevent {
    ...
    pub const SAVE: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u32) -> bool> = FunctionDef{address: 0x0060182e, function_type: PhantomData};
}
...
pub mod bfeventinfo {
    ...
    pub const SAVE: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u32) -> bool> = FunctionDef{address: 0x00601768, function_type: PhantomData};
}
...
pub mod bfeventmgr {
    ...
    pub const SAVE: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u32) -> bool> = FunctionDef{address: 0x0047afa5, function_type: PhantomData};
...
pub mod bfuimgr {
    ...
    pub const SET_CURSOR: FunctionDef<unsafe extern "thiscall" fn(*const u32, i32, i8)> = FunctionDef{address: 0x00418e81, function_type: PhantomData};
    ...
    pub const DISPLAY_HELP_0: FunctionDef<unsafe extern "thiscall" fn(*const u32, i32, i8)> = FunctionDef{address: 0x0041b100, function_type: PhantomData};
...
pub mod uitext {
    ...
    pub const RECALC_SCROLL_BAR: FunctionDef<unsafe extern "thiscall" fn(*const c_void)> = FunctionDef{address: 0x0040eaa0, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("uitext/render"))]
    pub const RENDER: FunctionDef<unsafe extern "thiscall" fn(*const c_void)> = FunctionDef{address: 0x0041a476, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("uitext/fit_to_text"))]
    pub const FIT_TO_TEXT: FunctionDef<unsafe extern "thiscall" fn(*const c_void)> = FunctionDef{address: 0x0041b0bb, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("uitext/set_scroll_bar"))]
    pub const SET_SCROLL_BAR: FunctionDef<unsafe extern "thiscall" fn(*const c_void, i32)> = FunctionDef{address: 0x004d4c5d, function_type: PhantomData};
}
...
pub mod ztanimal {
    ...
    pub const GET_SWIMS: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> bool> = FunctionDef{address: 0x004107d4, function_type: PhantomData};
    ...
    pub const PREYS_ON_MAN: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> bool> = FunctionDef{address: 0x004138f0, function_type: PhantomData};
    ...
    pub const IS_UNHAPPY_WITH_HABITAT: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> bool> = FunctionDef{address: 0x00418b8c, function_type: PhantomData};
...
pub mod ztawardmgr {
    ...
    pub const SAVE: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u32) -> bool> = FunctionDef{address: 0x0047a064, function_type: PhantomData};
...
pub mod ztcheat {
    ...
    pub const SAVE: FunctionDef<unsafe extern "cdecl" fn(*const u32) -> bool> = FunctionDef{address: 0x0047a10c, function_type: PhantomData};
...
pub mod zthabitat {
    ...
    #[cfg_attr(feature = "detour-validation", validate_detour("zthabitat/send_maint_worker_cleanup_events"))]
    ...
    pub const ZTHABITAT: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> *const u32> = FunctionDef{address: 0x00458cab, function_type: PhantomData};
...
pub mod zthabitatmgr {
    ...
    pub const SAVE: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u32) -> bool> = FunctionDef{address: 0x00479a54, function_type: PhantomData};
...
pub mod ztmapview {
    ...
    pub const USE_CURSOR_0: FunctionDef<unsafe extern "thiscall" fn(*const u32, i32)> = FunctionDef{address: 0x0043231a, function_type: PhantomData};
    ...
    pub const USE_CURSOR_1: FunctionDef<unsafe extern "thiscall" fn(*const u32, f32)> = FunctionDef{address: 0x00443d97, function_type: PhantomData};
    ...
    pub const FILL_CANVASES: FunctionDef<unsafe extern "thiscall" fn(*const u32)> = FunctionDef{address: 0x004ec8bf, function_type: PhantomData};
...
pub mod ztresearchbranch {
    ...
    pub const UPDATE: FunctionDef<unsafe extern "thiscall" fn(*const c_void, u32)> = FunctionDef{address: 0x0041f1ba, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztresearchbranch/pick_random_program"))]
    pub const PICK_RANDOM_PROGRAM: FunctionDef<unsafe extern "thiscall" fn(*const c_void)> = FunctionDef{address: 0x005b09f6, function_type: PhantomData};
}
...
pub mod ztresearchcategory {
    ...
    pub const LOAD_CATEGORY: FunctionDef<unsafe extern "thiscall" fn(*const c_void, *const i32) -> u32> = FunctionDef{address: 0x00590b76, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztresearchcategory/clear_category"))]
    pub const CLEAR_CATEGORY: FunctionDef<unsafe extern "thiscall" fn(*const c_void)> = FunctionDef{address: 0x005b0d44, function_type: PhantomData};
}
...
pub mod ztresearchmgr {
    ...
    pub const ZTRESEARCH_MGR: FunctionDef<unsafe extern "thiscall" fn(*const u32, u8) -> *const u32> = FunctionDef{address: 0x00504d37, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztresearchmgr/load"))]
    pub const LOAD: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> bool> = FunctionDef{address: 0x00593c3c, function_type: PhantomData};
...
pub mod ztresearchprogram {
    ...
    pub const ZTRESEARCH_PROGRAM: FunctionDef<unsafe extern "thiscall" fn(*const c_void)> = FunctionDef{address: 0x00501a3e, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztresearchprogram/on_completion"))]
    pub const ON_COMPLETION: FunctionDef<unsafe extern "thiscall" fn(*const c_void) -> u32> = FunctionDef{address: 0x0058fb83, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztresearchprogram/reset"))]
    pub const RESET: FunctionDef<unsafe extern "thiscall" fn(*const c_void) -> u32> = FunctionDef{address: 0x005900d8, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztresearchprogram/load_program"))]
    pub const LOAD_PROGRAM: FunctionDef<unsafe extern "thiscall" fn(*const c_void, *const u32) -> u32> = FunctionDef{address: 0x00590e00, function_type: PhantomData};
    #[cfg_attr(feature = "detour-validation", validate_detour("ztresearchprogram/constructor"))]
    pub const CONSTRUCTOR: FunctionDef<unsafe extern "thiscall" fn(*const c_void) -> *const u32> = FunctionDef{address: 0x0059109b, function_type: PhantomData};
}
...
pub mod ztscenery {
    ...
    #[cfg_attr(feature = "detour-validation", validate_detour("ztscenery/save"))]
    pub const SAVE: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u32) -> bool> = FunctionDef{address: 0x00477b03, function_type: PhantomData};
}
...
pub mod ztshowinfo {
    ...
    pub const SAVE: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u32) -> bool> = FunctionDef{address: 0x00610076, function_type: PhantomData};
}
...
pub mod ztshowmgr {
    ...
    pub const SAVE: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u32) -> bool> = FunctionDef{address: 0x00479fa4, function_type: PhantomData};
...
pub mod ztshowscriptitem {
    ...
    pub const SAVE: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u32) -> bool> = FunctionDef{address: 0x0061c471, function_type: PhantomData};
}
...
pub mod ztunit {
    ...
    #[cfg_attr(feature = "detour-validation", validate_detour("ztunit/check_predator"))]
    pub const CHECK_PREDATOR: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u32, bool) -> bool> = FunctionDef{address: 0x004391a2, function_type: PhantomData};
...
pub mod ztunittype {
    ...
    #[cfg_attr(feature = "detour-validation", validate_detour("ztunittype/is_underwater"))]
    pub const IS_UNDERWATER: FunctionDef<unsafe extern "thiscall" fn(*const u32) -> bool> = FunctionDef{address: 0x0040fc58, function_type: PhantomData};
...
pub mod zoostatus {
    ...
    pub const SAVE: FunctionDef<unsafe extern "thiscall" fn(*const u32, *const u32) -> bool> = FunctionDef{address: 0x0047ad4e, function_type: PhantomData};
...
pub mod std_basic_string {
    ...
    pub const BASIC_STRING_1: FunctionDef<unsafe extern "thiscall" fn(*const c_void, u32)> = FunctionDef{address: 0x00401d2d, function_type: PhantomData};
}
...
pub mod standalone {
    ...
    pub const WRITE_BYTES_TO_FILE: FunctionDef<unsafe extern "cdecl" fn(*const u32, u32, u32, *const u32) -> u32> = FunctionDef{address: 0x0047772e, function_type: PhantomData};
